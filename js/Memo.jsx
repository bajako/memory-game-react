...
import images from './LevelEasy';
import images1 from './LevelHard';
...
// jeśli mój dugi wybór odkrwa parę
    ...
    render() {
      ...
      if (this.state.points > 8) {
        ...
        const recordArr = (typeof localStorage['memoRecords'] != 'undefined') ? JSON.parse(localStorage.getItem('memoRecords')) : [
        ...
        return (
          <div className='fullScreen memoryTable'>
      ...
      return (
        <div className='container'>
          ...
          <div className='level'>
            <input type='button' className='btn1' value='easy' onClick={this.handleEasy}/>
            <input type='button' className='btn1' value='hard' onClick={this.handleHard}/>
          </div>
